...
AETHERFLOW_DEV_API_HOST="${AETHERFLOW_DEV_API_HOST:-0.0.0.0}"
AETHERFLOW_DEV_API_PORT="${AETHERFLOW_DEV_API_PORT:-18080}"
AETHERFLOW_DEV_FRONTEND_HOST="${AETHERFLOW_DEV_FRONTEND_HOST:-0.0.0.0}"
AETHERFLOW_DEV_FRONTEND_PORT="${AETHERFLOW_DEV_FRONTEND_PORT:-5180}"
