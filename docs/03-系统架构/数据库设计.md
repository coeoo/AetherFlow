...
```text
task_jobs 1 --- n task_attempts
task_jobs 1 --- 1 cve_runs
task_jobs 1 --- 1 announcement_runs

delivery_targets 1 --- n delivery_records
artifacts 1 --- n cve_patch_artifacts
artifacts 1 --- n announcement_documents

cve_runs 1 --- n cve_fix_families
cve_runs 1 --- n cve_patch_artifacts

announcement_sources 1 --- n source_fetch_records
source_fetch_records 1 --- n announcement_runs
announcement_sources 1 --- n announcement_runs
announcement_runs 1 --- 1 announcement_documents
announcement_documents 1 --- 1 announcement_intelligence_packages
```
